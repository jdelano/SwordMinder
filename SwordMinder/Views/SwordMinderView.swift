...
struct SwordMinderView: View {
    ...
    var body: some View {
        switch currentApp {
            ...
            case .justMemorizeApp: JM_MainMenu(justMemorize: JustMemorize(difficulty: "Easy", reference: Reference(), input: "Typing", toggleVerse: true, toggleTimer: true), currentApp: .constant(.justMemorizeApp), toggleVerse: .constant(true), toggleTimer: .constant(true))
        }
    }
